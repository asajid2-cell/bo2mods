param(
    ...
    [string]$IdleStaticTranslate = "0,0,80",
    [switch]$Launch,
    [switch]$InjectProbe,
...
$oracleFf = Join-Path $root "_build\xanim_oracles\vm_zod_idle_donorclone_mod_load.ff"
...
$env:ROGUE_BO3_ANIM_DONOR_ZONE = "mod_load"
$env:ROGUE_BO3_ANIM_DONOR_ASSET = "vm_zod_id_gun_idle"
