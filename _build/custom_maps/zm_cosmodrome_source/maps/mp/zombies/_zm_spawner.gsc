...
zombie_goto_entrance( node, endon_bad_path )
{
    ...
    // Offline animation-integration lane: keep zombies out of the barricade tear-down
    // path so the runtime stays alive long enough to observe weapon animation binding.
    self zombie_complete_emerging_into_playable_area();
    return;
...
zombie_death_animscript()
{
    ...
    if ( self.has_legs
        && !( isdefined( self.is_avogadro ) && self.is_avogadro )
        && isdefined( self.a.gib_ref )
